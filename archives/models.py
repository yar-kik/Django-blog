...
class Film(InfoBase):
    ...
    image = models.ImageField(upload_to='archives/films', blank=True, null=True)
...
class Anime(InfoBase):
    ...
    image = models.ImageField(upload_to='archives/anime', blank=True, null=True)
...
class Game(InfoBase):
    ...
    image = models.ImageField(upload_to='archives/games', blank=True, null=True)
